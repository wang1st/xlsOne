...
{
    return AlgorithmKeywords::instance().amountPatterns();
}

QStringList weakAmountSemanticPatterns()
{
    return AlgorithmKeywords::instance().weakAmountPatterns();
}

QStringList codeSemanticPatterns()
{
    return AlgorithmKeywords::instance().codePatterns();
}

QStringList labelSemanticPatterns()
{
    return AlgorithmKeywords::instance().labelPatterns();
}
